  ...
  return (
    <footer className='w-full p-10 mb-[100px] md:mb-5' id="contact">
      <div className='flex flex-col items-center'>
        <h1 className='text-custom-teal w-45 text-center text-5xl font-semibold '>
          Contact
        </h1>
        <p className='text-custom-teal text-lg font-medium md:mt-10 my-5 text-center p-5'>If you have any suggestions, project or even you want to say “hello”, feel free to reach out to me via email, or any of the platforms below.</p>
      ...
      <div className='flex md:flex-grow flex-col justify-between items-center'>
        <div className='flex items-center md:gap-3 gap-6 p-3 '>
